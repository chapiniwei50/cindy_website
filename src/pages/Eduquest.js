...
import './Eduquest.css'; // Use the same CSS for consistent styling

const PathatPenn = () => {
  return (
    <Box className="project-detail-container">
      {/* Top Logo Section */}
      <Box className="edu-logo-section">
        <img
          src="/image/eduquestlogo.png" // Replace with the Path@Penn logo path
          alt="Path@Penn Logo"
